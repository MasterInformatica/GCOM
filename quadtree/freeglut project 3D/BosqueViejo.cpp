#include "BosqueViejo.h"



BosqueViejo::BosqueViejo(){
	q = gluNewQuadric();
}
...
void BosqueViejo::dibujaTronco(float rBase, float h, int meridianos, int paralelos){
